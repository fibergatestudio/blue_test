...
class CreateTrainingsSubscriptionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trainings_subscription', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('trainings_subscription');
    }
}
