...
return [
    ...
    'contacts' => [
        ...
        'address' => 'CÍM',
        'coffee-manager' => 'Kávéáruház-kezelő',
        'head-manager' => 'FEJKEZELŐ',
        'education' => 'BARISTÁK OKTATÁSA ÉS SZAKMAI KONZULTÁCIÓ',
        'order' => 'Megrendelést készíteni',
        'co-operate' => 'Nyitottak vagyunk az együttműködésre',
        'questions' => 'Ha bármilyen kérdése vagy észrevétele van, írjon nekünk!',
        'with-questions' => 'Minden más kérdéssel',
