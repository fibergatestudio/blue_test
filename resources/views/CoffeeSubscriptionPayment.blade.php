                        ...
                        <div class="sidebar-form__content">
                            <div class="sidebar-order">
                                ...
                                <ul class="sidebar-order__list">
                                    ...
                                    <li class="sidebar-order__list-item"><span class="sidebar-order__key">Ships every</span><span class="sidebar-order__val">Week</span>
                                    </li>
                                </ul>
                                <ul class="sidebar-order__list">
                                    <li class="sidebar-order__list-item"><span class="sidebar-order__key">Price</span><span class="sidebar-order__val">20 700 HUF</span>
                                    </li>
                                ...
                                <a href="{{ url('coffeesubscription/#changeOrder') }}"><button class="sidebar-order__change button button_blue">Change order</button></a>
                            </div>
                        </div>
                    </div>
                </aside>
                                ...
                                <div class="cart-settings__forms">
                                    ...
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            ...
                                            <input class="input-text__input" id="lastName" type="text" name="last-name">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="address1">Adress 1</label>
                                            <input class="input-text__input" id="address1" type="text" name="address-1">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="address2">Adress 2</label>
                                            <input class="input-text__input" id="address2" type="text" name="address-2">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="city">City</label>
                                            <input class="input-text__input" id="city" type="text" name="city">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="country">Country</label>
                                            <input class="input-text__input" id="country" type="text" name="country">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="zip">Zip</label>
                                            <input class="input-text__input" id="zip" type="text" name="zip">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="phone">Phone</label>
                                            <input class="input-text__input" id="phone" type="tel" name="phone">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cart-settings__forms">
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            ...
                                            <input class="input-text__input" id="email" type="email" name="email">
                                        </div>
                                    </div>
                                    <div class="cart-settings__form-item">
                                        <div class="input-text">
                                            <label class="input-text__label" for="password">Password</label>
                                            <input class="input-text__input" id="password" type="password" name="password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="cart-settings__send">
                                        <button class="button button_blue">Complete checkout</button>
                                    </div>
                                </div>
                            </div>
                        </div>
