...
<main>
            <div class="page page_has-filter">
                <form action="{{ url('/trainings/subscribe') }}" method="POST">
                    @csrf()
                    ...
                    <div class="sidebar-form">
                        ...
                        <div class="sidebar-form__content">
                            <div class="sidebar-order">
                                ...
                                <hr>
                                <!-- Test Info -->
                                    @if(!empty($trainings_sub))
                                        <p>Current sub: {{ $trainings_sub->subscription_name }}</p>
                                    @else
                                        <p>Current sub: None</p>
                                    @endif
                ...
                <div class="page__content">
                    <div class="container page__container">
                        ...
                        <div class="cart-settings">
                            ...
                            <h2 class="page__title">Payment options:</h2>
                            <div class="cart-settings__box cart-settings__box_p-100 cart-settings__box_payment-opts">
                                <div class="input-radio">
                                    <input class="input-radio__real" id="prepayment" type="radio" name="prepayment">
                                    <label class="input-radio__label" for="prepayment">10% (prepayment)</label>
                                </div>
                                <div class="input-radio">
                                    <input class="input-radio__real" id="foolpayment" type="radio" name="foolpayment" checked>
                                    <label class="input-radio__label" for="foolpayment">Full payment</label>
                                </div>
                            </div>
